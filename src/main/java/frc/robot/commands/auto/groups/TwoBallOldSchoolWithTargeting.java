...
public class TwoBallOldSchoolWithTargeting extends SequentialCommandGroup {

  private MasterContoller m_masterController;
  private DriveTrain m_drivetrain;

  public TwoBallOldSchoolWithTargeting(MasterContoller in_masterController, DriveTrain in_drivetrain) {
