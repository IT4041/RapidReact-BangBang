...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain(NavX in_navX) {
    ...
    SmartDashboard.putNumber("Drivetrain Right Encoder", 0);
    SmartDashboard.putNumber("Drivetrain Left Encoder", 0);
    SmartDashboard.putNumber("Drivetrain Right Distance", 0);
    SmartDashboard.putNumber("Drivetrain Left Distance", 0);
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Drivetrain Right Encoder", topRightTalon.getSelectedSensorPosition());
    SmartDashboard.putNumber("Drivetrain Left Encoder", topLeftTalon.getSelectedSensorPosition());
    SmartDashboard.putNumber("Drivetrain Right Distance", this.getRightDistance());
    SmartDashboard.putNumber("Drivetrain Left Distance", this.getLeftDistance());
  ...
  public void arcadeDrive(double FWD, double ROT) {
    m_drive.arcadeDrive(ROT*0.65,FWD*0.825, true);
  }
  ...
  public void tankDriveVoltsNoParams() {
    m_leftMotors.setVoltage(3);
    m_rightMotors.setVoltage(-3);
    m_drive.feed();
  }
